        ...
        <aside class="bg-white w-64 shadow-md sidebar-sticky">
            ...
            <nav class="px-4 py-6">
                ...
                <div class="mb-4">
                    ...
                    <ul>
                        <li class="mb-4">
                            <a href="eServices" class="flex items-center text-blue-500 font-bold bg-blue-100 p-2 rounded">
                                <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 mr-2" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                        ...
                        <li class="mb-4">
                            <a href="eCommandCenter.html" class="flex items-center text-gray-700 p-2 rounded hover:bg-gray-100">
                                <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 mr-2" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                        ...
                        <li class="mb-4">
                            <a href="eResponse" class="flex items-center text-gray-700 p-2 rounded hover:bg-gray-100">
                                <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 mr-2" fill="none" viewBox="0 0 24 24" stroke="currentColor">
